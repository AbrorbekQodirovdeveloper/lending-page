    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
           ...
           <div class="navbar-nav w-100">
                    <a href="{{ route('admin') }}" class="nav-item nav-link "><i class="fas fa-home"></i>Home</a>
                    ...
                    <a href="{{ route('all.feature') }}" class="nav-item nav-link"><i class="fas fa-table me-2"></i>Features</a>
                    <a href="{{ route('message') }}" class="nav-item nav-link"><i class="fas fa-comments"></i>Message</a>
                    <a href="{{ route('adminview.page') }}" class="nav-item nav-link active"><i class="fa fa-user-alt"></i>Client</a>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            ...
            <a href="" class="btn btn-primary float-right">Add to client </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                @foreach ($user as $item)
                  <tr>
                    ...
                    <td width="12%">
                      ...
                      <a href="" class="btn btn-danger" title="Выключать" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
