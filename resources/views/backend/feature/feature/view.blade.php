      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            ...
            <a href="{{ route('feature.add') }}" class="btn btn-primary float-right">Add to feature </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
              ...
              <tbody>
                @foreach ($features as $item)
                  <tr>
                    ...
                    <td>{{ $item->about }}</td>
                    <td width="12%">
                      <a href="{{ route('feature.edit', $item->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('feature.delete' , $item->id) }}" class="btn btn-danger" title="Выключать" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
