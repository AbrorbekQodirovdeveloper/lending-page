...
<img class="rounded-circle" src="{{ asset('img/user.jpg') }}" alt="" style="width: 40px; height: 40px;">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('pricing.update' , $pricings->id) }}" method="POST" class="col-12 mt-5">
                       @csrf
         ...
         <div class="row">
    <div class="col-10">
     <input type="text" class="form-control" name="name" placeholder="Your pricing name" value="{{ $pricings->name }}"><br>
     @error('name')
     <span class="text-danger">{{ $message }}</span>
      @enderror
    <input type="text" class="form-control" name="title" placeholder="Your pricing title"  value="{{ $pricings->title }}"><br>
  @error('title')
     <span class="text-danger">{{ $message }}</span>
      @enderror
    <input type="number" class="form-control" name="price" placeholder="Your pricing price"  value="{{ $pricings->price }}"><br>
  @error('price')
     <span class="text-danger">{{ $message }}</span>
      @enderror
