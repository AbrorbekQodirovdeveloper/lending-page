...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('pricing.store') }}" method="POST" class="col-12 mt-5">
                       @csrf
    ...
    <div class="col-10">
     ...
     <span class="text-danger">{{ $message }}</span>
      @enderror
    <input type="text" class="form-control" name="title" placeholder="Your pricing title"><br>
  @error('title')
     <span class="text-danger">{{ $message }}</span>
      @enderror
    <input type="number" class="form-control" name="price" placeholder="Your pricing price"><br>
  @error('price')
     <span class="text-danger">{{ $message }}</span>
      @enderror
