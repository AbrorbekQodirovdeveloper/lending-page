...
<img class="rounded-circle" src="{{ asset('img/user.jpg') }}" alt="" style="width: 40px; height: 40px;">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('main.update' , $mains->id) }}" method="POST" class="col-12 mt-5">
                       @csrf
     ...
     <div class="col-10">
                ...
                @error('site_title')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                 <input type="text" class="form-control" name="site_description" placeholder="Your main site description" value="{{ $mains->site_description }}"><br>
                @error('site_description')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="text" class="form-control" name="adress" placeholder="Your main address" value="{{ $mains->adress }}"><br>
                @error('adress')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
