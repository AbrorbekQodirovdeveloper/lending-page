      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            ...
            <a href="{{ route('main.add') }}" class="btn btn-primary float-right">Add to main </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                @foreach ($mains as $item)
                  <tr>
                    ...
                    <th>{{ $item->id }}</th>
                     <td width="15%">
                      <img
                      src="{{ asset($item->site_logo) }}"
                      style="width: 90px; height: 60px;">
                    </td>
                    <td>{{ $item->site_about }}</td>
                    ...
                    <td width="12%">
                      <a href="{{ route('main.edit' , $item->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('main.delete' , $item->id) }}" class="btn btn-danger" title="Delete" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
