...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="{{ route('all.main') }}" class="navbar-brand mx-4 mb-3">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('main.store') }}" method="POST"  enctype="multipart/form-data" class="col-12 mt-5">
                       @csrf
    ...
    <div class="col-10">
                  ...
                  <input type="text" class="form-control" name="site_about" placeholder="Your main site about"><br>
                @error('site_about')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                  <input type="text" class="form-control" name="site_title" placeholder="Your main site title"><br>
                @error('site_title')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                 <input type="text" class="form-control" name="site_description" placeholder="Your main site description"><br>
                @error('site_description')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="text" class="form-control" name="adress" placeholder="Your main address"><br>
                @error('adress')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="text" class="form-control" name="phone" placeholder="Your main phone"><br>
                @error('phone')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
