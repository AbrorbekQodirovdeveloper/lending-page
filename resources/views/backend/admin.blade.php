        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('admin') }}" class="nav-item nav-link active"><i class="fa fa-home"></i>Home</a>
...
<center>
<p>
You can manage Appvilla site in this Admin panel, you can add, change and delete data on this site.</p>
</center>
