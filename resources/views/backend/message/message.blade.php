    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
           ...
           <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('message') }}" class="nav-item nav-link active "><i class="fas fa-comments"></i>Message</a>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            ...
            <a href="" class="btn btn-primary float-right">Add to Message </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                @foreach ($contacts as $item)
                  <tr>
                    ...
                    <td width="12%">
                      ...
                      <a href="{{ route('contact.delete' , $item->id) }}" class="btn btn-danger" title="Delete" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
